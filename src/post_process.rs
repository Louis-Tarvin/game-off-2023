...
impl Plugin for PostProcessPlugin {
    fn build(&self, app: &mut App) {
        app.register_type::<TransitionSettings>().add_plugins((
            ...
            ExtractComponentPlugin::<TransitionSettings>::default(),
            // The settings will also be the data used in the shader.
            // This plugin will prepare the component for the GPU by creating a uniform buffer
            // and writing the data to that buffer every frame.
            UniformComponentPlugin::<TransitionSettings>::default(),
        ));
...
impl ViewNode for PostProcessNode {
    ...
    fn run(
        ...
        let settings_uniforms = world.resource::<ComponentUniforms<TransitionSettings>>();
...
impl FromWorld for PostProcessPipeline {
    fn from_world(world: &mut World) -> Self {
            ...
            entries: &[
                ...
                BindGroupLayoutEntry {
                    ...
                    ty: BindingType::Buffer {
                        ...
                        min_binding_size: Some(TransitionSettings::min_size()),
                    },
                    count: None,
                },
            ],
        ...
        let shader = world
            ...
            .load("shaders/transition_postprocess.wgsl");
